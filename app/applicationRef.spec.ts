...
import { ComponentFixtureNoNgZone, TestBed, async, inject, withModule } from '@angular/core/testing';
...
export function main() {
  describe('bootstrap', () => {
    ...
    function createModule(providersOrOptions: any[] | CreateModuleOptions): Type<any> {
      ...
      const platformModule = getDOM().supportsDOMEvents() ? BrowserModule : null;
    ...
    describe('ApplicationRef', () => {
      ...
      it('should throw when reentering tick', inject([ApplicationRef], (ref: ApplicationRef) => {
